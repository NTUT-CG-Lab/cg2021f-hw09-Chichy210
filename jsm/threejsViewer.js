...
class threejsViewer {
    constructor(domElement) {
        ...
        this.loadData = () => {
            if (this.scene.getObjectByName("mesh") != undefined){
        ...
        this.download = () => {
            let download_geometry = mesh.generateGeometry()
            let download_mesh = new THREE.Mesh(download_geometry)
            return download_mesh
        }
